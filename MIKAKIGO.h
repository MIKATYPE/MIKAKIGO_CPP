...
void pshiftfinger(HDC g,int s,int flag);
void dispshiftposit(HDC g,int shift_mode);
int fngposit(int finger);
void difposit2(HDC g,int yy,int flag);
void difposit(HDC g,wchar_t a,int flag);
void dispguidechar(HDC g,wchar_t key_char,int flag);
void dipline(HDC g,int x, wstring line1,wstring line2,int flag,int shift_mode);
void dipline2(HDC g,int x, wstring line,int flag,int shift_mode);
int errcharpos(wchar_t a,wchar_t b);
wchar_t recovererrchar(wchar_t a);
int dikposit(HDC g,wchar_t a,int flag);
int dikposit2(HDC g,wchar_t a,int x,int y,int flag);
