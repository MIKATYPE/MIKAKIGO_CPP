/* ************************************************************************** */
/* 美佳のタイプトレーナー 記号編 C++ 版ソースコード Ver2.02.01   2023/12/20   */
/*                                           Copy right 今村二朗              */
/*                                                                            */
...
/*                                                                            */
/* ************************************************************************** */
// MIKAKIGO.cpp : アプリケーションのエントリ ポイントを定義します。
//
...
char MIKA_file_name_seiseki[] = "mikakigo.sei"; /* 成績ファイル名 読み込み用 */
char MIKA_file_name_seiseki2[] = "mikakigo.sei"; /* 成績ファイル名 書き込み用 */
char MIKA_file_name_kiroku[] = "mikakigo.log"; /* 練習時間記録ファイル名 追記用 */
char MIKA_file_name_hayasa[] = "mikakigo.spd"; /* 最高速度記録ファイル名 追記用 */
...
string	MIKA_r_date[] = /* ランダム練習 最高速度達成日付 */
	...
	wstring MIKA_a_pos1=L"1234567890"; /* キーボード最上段 数字 文字列 */
	wstring MIKA_k_pos1_c1=L"-^\\"; /* キーボード 最上段 シフト無し記号 文字列 */
	wstring MIKA_z_pos1_c1=L"－＾￥"; /* キーボード 最上段 シフト無し記号 全角文字列 */
	wstring MIKA_k_pos1_c2=L"!\"#$%&'() =~|"; /* キーボード最上段 シフト有り記号 表示文字列 */
	wstring MIKA_k_pos1_h2=L"!\"#$%&'()=~|"; /* キーボード最上段 シフト有り記号 練習文字列 */
	wstring MIKA_z_pos1_c2=L"！”＃＄％＆’（）　＝～｜"; /* キーボード最上段 シフト有り記号 表示全角文字列 */
	wstring MIKA_c_pos1=MIKA_a_pos1+MIKA_k_pos1_c1; /* キーボード最上段 シフト無し 文字列 */ 
	wstring MIKA_s_pos1=MIKA_k_pos1_c2; /* キーボード最上段 シフト有り 文字列 */
	wstring MIKA_a_pos2=L"QWERTYUIOP"; /* キーボード 上一段 シフト無し 英文字 文字列 */
	wstring MIKA_k_pos2_c1=L"@["; /* キーボード 上一段 シフト無し記号 文字列 */
	wstring MIKA_z_pos2_c1=L"＠［"; /* キーボード 上一段 シフト無し記号 全角文字列 */
	wstring MIKA_k_pos2_c2=L"`{"; /* キーボード 上一段 シフト有り記号 文字列 */
	wstring MIKA_z_pos2_c2=L"｀｛"; /* キーボード 上一段 シフト有り記号 全角文字列 */
	wstring MIKA_c_pos2=MIKA_a_pos2+MIKA_k_pos2_c1; /* キーボード 上一段 シフト無し 文字列 */
	wstring MIKA_s_pos2=MIKA_a_pos2+MIKA_k_pos2_c2; /* キーボード 上一段 シフト有り 文字列 */
	wstring MIKA_a_pos3=L"ASDFGHJKL"; /* キーボード ホームポジション 英文字 文字列 */
	wstring MIKA_k_pos3_c1=L";:]"; /* キーボード ホームポジション シフト無し記号 文字列 */
	wstring MIKA_z_pos3_c1=L"；：］";	/* キーボード ホームポジション シフト無し記号 全角文字列 */
	wstring MIKA_k_pos3_c2=L"+*}"; /* キーボード ホームポジション シフト有り記号 文字列 */
	wstring MIKA_z_pos3_c2=L"＋＊｝"; /* キーボード ホームポジション シフト有り記号 全角文字列 */
	wstring MIKA_c_pos3=MIKA_a_pos3+MIKA_k_pos3_c1; /* キーボード ホームポジション シフト無し 文字列 */
	wstring MIKA_s_pos3=MIKA_a_pos3+MIKA_k_pos3_c2; /* キーボード ホームポジション シフト有り 文字列 */
	wstring MIKA_a_pos4=L"ZXCVBNM"; /* キーボード 下一段 英文字 文字列 */
	wstring MIKA_k_pos4_c1=L",./＼"; /* キーボード 下一段 シフト無し記号 文字列 */
	wstring MIKA_k_pos4_h1=L",./"; /* キーボード 下一段 シフト無し記号 練習 文字列 */
	wstring MIKA_z_pos4_h1=L"，．／"; /* キーボード 下一段 シフト無し記号 練習 全角文字字列 */ 
	wstring MIKA_k_pos4_c2=L"<>?_"; /* キーボード 下一段 シフト有り記号 文字列 */
	wstring MIKA_z_pos4_c2=L"＜＞？＿"; /* キーボード 下一段 シフト有り記号 全角文字列 */
	wstring MIKA_c_pos4=MIKA_a_pos4+MIKA_k_pos4_c1; /* キーボード 下一段刻文字列 */
	wstring MIKA_s_pos4=MIKA_a_pos4+MIKA_k_pos4_c2; /* キーボード 下一段刻文字列 */
	wstring MIKA_c_post[] = {MIKA_c_pos1,MIKA_c_pos2,MIKA_c_pos3,MIKA_c_pos4}; /* キーボード シフト無し 刻印文字列テーブル */
	wstring MIKA_s_post[] = {MIKA_s_pos1,MIKA_s_pos2,MIKA_s_pos3,MIKA_s_pos4}; /* キーボード シフト有り 刻印文字列テーブル */
	wstring MIKA_h_pos1=MIKA_c_pos3+MIKA_k_pos3_c1+MIKA_k_pos3_c2+MIKA_k_pos3_c2; /* ホームポジション 練習文字列 */
	wstring MIKA_h_pos2=MIKA_c_pos2+MIKA_k_pos2_c1+MIKA_k_pos2_c2+MIKA_k_pos2_c2; /* 上一段 練習文字列 */
	wstring MIKA_h_pos3=MIKA_h_pos1+MIKA_h_pos2; /* ホームポジション＋上一段 練習文字列 */
	wstring MIKA_h_pos4=MIKA_a_pos4+MIKA_k_pos4_h1+MIKA_k_pos4_h1+MIKA_k_pos4_c2+MIKA_k_pos4_c2; /* 下一段 練習文字列 */
	wstring MIKA_h_pos5=MIKA_h_pos1+MIKA_h_pos4; /* ホームポジション＋下一段 練習文字列 */
	wstring MIKA_h_pos6=MIKA_h_pos1+MIKA_h_pos2+MIKA_h_pos4; /* ホームポジション＋上一段＋下一段 練習文字列 */
	wstring MIKA_h_pos7=MIKA_a_pos1+MIKA_k_pos1_c1+MIKA_k_pos1_c1+MIKA_k_pos1_h2+MIKA_k_pos1_h2; /* 最上段 練習文字列 */
	wstring MIKA_h_pos8=MIKA_h_pos1+MIKA_h_pos2+MIKA_h_pos4+MIKA_h_pos7; /* 全段  練習文字列 */
	...
	wstring MIKA_h_table=MIKA_k_pos1_c1+MIKA_k_pos1_c2+MIKA_k_pos2_c1+MIKA_k_pos2_c2+MIKA_k_pos3_c1+MIKA_k_pos3_c2+MIKA_k_pos4_h1+MIKA_k_pos4_c2; /* 半角記号文字テーブル */
	wstring MIKA_z_table = MIKA_z_pos1_c1 + MIKA_z_pos1_c2 + MIKA_z_pos2_c1 + MIKA_z_pos2_c2 + MIKA_z_pos3_c1 + MIKA_z_pos3_c2 + MIKA_z_pos4_h1 + MIKA_z_pos4_c2; /* 全角記号文字テーブル */
...
int MIKA_text_underline=0; /* ランダム練習の下線表示位置 */
...
int	MIKA_char_position = 0; /* 練習文字番号 ポジション練習 にてランダムに文字を選択する時のポインター */
wchar_t MIKA_key_char = 0; /* 練習文字 */
wchar_t MIKA_guide_char = 0; /* ガイドキー文字 */
wchar_t MIKA_err_char = 0; /* エラー文字 */
wchar_t MIKA_capital_char=MIKA_a_pos3[0]; /* エラー文字 小文字大文字変換用 基準文字 */
...
int MIKA_menu_cord[9][2] = { /* ポジション練習 ランダム練習 メニュー項目表示位置 x座標 y座標 */
    {2 * 14,20 * 8},
    {4 * 14,20 * 8},
    {6 * 14,20 * 8},
    {8 * 14,20 * 8},
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MIKAKIGO, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MIKAKIGO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MIKAKIGO));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MIKAKIGO);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   SetMenu(hWnd, NULL); /* メニューバー非表示 */
	SetWindowText(hWnd,L"美佳記号"); /* タイトル設定 */
 		...
 		if(400<MIKA_exec_func_no&&MIKA_exec_func_no<500) /* ポジション練習の場合 */
		{
			if(MIKA_practice_end_flag==0) /* 練習実行中の場合 */
			{
				if(MIKA_err_char!=0) /* エラーキー表示中の場合 */
				{
					...
					{
//       					cslput(hdc,100,100,"KEY UP");
						if(errcharpos(MIKA_err_char,MIKA_guide_char)==1) /* エラーキーとガイドキーの表示位置が同じ場合 */
						{
							dikposit(hdc,MIKA_guide_char,0); /* ガイドキー文字の位置を表示 */
...
//							cslput(g,100,100,"key released");
	...
	case WM_TIMER:
	{
			...
			switch (wmId)
			{
			case MIKA_Procptimer_ID: /* ポジション練習の場合 */
			{
...
void cslputzscale(HDC g,int x1,int y1,wchar_t a,double scale) /* 半角英数を全角文字に変換して指定の倍率で表示 */
	{
		...
		else /* 記号を半角から全角に変換 */
		{
			...
			if(i!=0)
			{
				aa=MIKA_z_table[i-1];  /* 対応する記号全角文字を設定 */
			}
			else
 			{
				aa=a;
...
void cslputwscale(HDC g, int x, int y, wchar_t mes[], double scale)/* 仮想座標から実座標に変換してワイド文字列を指定の倍率で表示 */
{
    ...
    for (i = 0;i < 256;i++)
    {
        ...
        b[0] = c;
        b[1] = 0;
        yy = ycord(y + (int)(ii*8*scale)); /* 表示位置 y座標を仮想座標から実座標に変換 */
...
int ycord(int y1) /* 仮想y座標を 実y座標に変換 */
{
	...
	int xxcord(int x) /* ランダム練習 で 練習文字の表示x仮想座標を計算 */
	{
		int xx;
		xx = MIKA_t_line * 16 + x * 20; /* MIKA_t_lineを開始行にして、ドット高さ20ドットで表示 */
		return xx;
	}
	int yycord(int y) /* ランダム練習 で 練習文字の表示y仮想座標を計算 */
	{
		int yy;
...
void pshiftfinger(HDC g,int s,int flag) /* シフトキーを表示する */
{
/*   シフトキーの指ガイドを表示 */
/*   s=0 左側のシフトキー */
/*	 s=1 右側のシフトキー */
...
/*   flag= 1 シフトキー消去 */
	...
	keyposit(&x_pos0,&y_pos0,x,y); /* 長方形の表示位置を仮想座標に変換 */
	keyposit(&x_pos1,&y_pos1,x,y+1); /* 二個分のキーの右側の表示位置を仮想座標に変換 */
	cslrectb(g,x_pos0-dx,y_pos0-dy,x_pos0+3*MIKA_width_x+dx,y_pos1+4*MIKA_width_y+dy,MIKA_key_black,MIKA_key_gray,1); /* キー二個分の長方形を表示 */
	if(flag==0)
	{
		cslrectt(g,x_pos0+MIKA_width_x-ddx,y_pos0+MIKA_width_y-ddy,x_pos0+2*MIKA_width_x+ddx,y_pos1+3*MIKA_width_y+ddy,MIKA_key_blue); /* シフトキー文字の背景を青色を表示 */
//		pDC->SetBkColor(color3);
		cslcolor(g,MIKA_key_gray); /* 文字 をグレーで表示 */
		cslbkcolor(g,MIKA_key_blue); /* 文字背景を青に設定 */
	}
	else
	{
//		pDC->SetBkColor(color1);
		cslcolor(g,MIKA_key_black); /* 文字を黒で表示 */
		cslbkcolor(g,MIKA_key_gray); /* 文字背景をグレーに設定 */
	}
	cslputscale(g,x_pos0+MIKA_width_x,y_pos0+MIKA_width_y+ddy,ss,1.4); /* SHIFT の文字を表示 */
}
void 	dispshiftposit(HDC g,int shift_mode) /* 現在表示中のシフトキーと今回表示のシフトキーが異なる場合に表示を更新 */
{
	...
	void difposit2(HDC g,int yy,int flag) /* 指番号に対応したキーを打つ指の爪を表示 */
// flag=0 爪を黒で表示
// flag=1 爪を元の色に戻して表示
	{
		COLORREF color1;
...
void dipline(HDC g,int x, wstring line1,wstring line2,int flag,int shift_mode) /* キーボード一列表示*/
{
	int sshift_mode;
...
void dipline2(HDC g,int x, wstring line,int flag,int shift_mode) /* シフトモードに対応してキーボード一列表示*/
// x 表示行位置番号 
// line キートップ文字列 
...
int errcharpos(wchar_t a,wchar_t b) /* エラー文字とガイドキー文字のキーの位置が同じ位置かを判定する */
// =0 一致しない
// =1 一致する
{
	int x1,y1,x2,y2;
	keycord(&x1,&y1,a); /* エラー文字の表示位置を取得 */
	if(x1==0||y1==0) return(0); /* 無効キーの場合は =0 でリターン */
	keycord(&x2,&y2,b); /* ガイドキー文字の表示位置を取得 */
	if(x2==0||y2==0) return(0); /* 無効キーの場合は =0 でリターン */
	if(x1==x2&&y1==y2) return(1); /* 表示位置が同一の場合は =1でリターン */
	else return(0); /* 表示位置が異なる場合は =0 でリターン */
}
wchar_t recovererrchar(wchar_t a) /* エラー文字位置に表示されていた元の文字を取得 */
{
		int shift_mode;
		int x,y;
		wchar_t b;
		...
		if(shift_mode==x) /* シフト表示行にエラー文字が表示された場合 */
		{
			...
			{
				b=MIKA_c_post[x-1][y-1];
			}
		}
		else /* シフト表示行でない行にエラー文字が表示された場合 */
		{
				b=MIKA_c_post[x-1][y-1]; /* シフト無しの文字を取得 */
		}
		return b;
}
	int dikposit(HDC g,wchar_t a,int flag) /* ポジション練習でエラー文字とガイドキー文字の表示及び復帰を行う */
	{
		...
		if(x==0||y==0) return(0); /* 無効キーの場合は =0 でリターン */
...
//			else
	...
	int dikposit2(HDC g,wchar_t a,int x,int y,int flag) /* ポジション練習でエラー文字とガイドキー文字の表示及び復帰を一文字づつ行う */
//	a ガイドキーの文字
...
//	flag=3 エラーキー文字の表示は赤い背景で表示
	{
		...
		if(a==0) return(0); /* 無効キーの場合は =0 でリターン */
		if(x==0||y==0) return(0); /* 無効キーの場合は =0 でリターン */
		...
		if(flag==0||flag==1||flag==3) /* 文字表示有りの場合 */
		{
...
// flag=0 表示 flag=1 消去 
	...
	void dispabortmes2(HDC g,int flag) /* ランダム練習 で 「ESCキーを押すと中断します」のメッセージを表示 */
// flag=0 表示 flag=1 消去 
	{
...
//					dispbkchar(g,jj,ii,MIKA_random_scale); /* 文字の背景を赤色で表示 */ /* 2023/2/25 新コード */
	...
	void dispunderline(HDC g) /* ランダム練習 下線表示 */
	{
		int i,j,k;
		int ii,jj;
		int kazu_yoko=40; /* 横文字数 */
	...
	void dispmaxspeedrecord(HDC g,int i1,int j1,int i2,int j2) /* ランダム練習 の 最高入力速度と 達成日を表示 */
	{
			char a[27],b[16];
...
void 	dispgrid(HDC g) /* ランダム練習にてグリッドを表示する */
	{
		int i,j,k;
		HPEN oldpen; /* 旧ペン */
		HPEN pen1; /* 新ペン */
		int x1,x2,y1,y2;
		pen1=CreatePen(PS_SOLID,1,MIKA_green); /* 緑色のペンを生成 */
        oldpen=(HPEN)SelectObject(g,pen1); /* 旧ペンを保存して新ペンを設定 */
		k=0;
		for(j=0;j<10;j++) /* 最大10行描画 */
		{
			x1=xcord(MIKA_t_line*16+j*20-1); /* グリッド縦線開始x座標を取得 */
			x2=xcord(MIKA_t_line*16+j*20+16+1); /* グリッド縦線終了x座標を取得 */
			for(i=0;i<80;i=i+2) /* グリッド縦線を40本描画 */
			{
				y1=ycord(i*8); /* 縦線y座標を取得 */
				MoveToEx(g,y1,x1,NULL); /* 縦線開始位置にペンを移動 */
				LineTo(g,y1,x2); /* 縦線描画 */
				k++;
			}
			y1=ycord(0); /* グリッド横線開始y座標を取得 */
			y2=ycord(640-1); /* グリッド横線終了y座標を取得 */
			MoveToEx(g,y2,x1,NULL);
			LineTo(g,y2,x2); /* グリッド最右縦線描画 */
			MoveToEx(g,y1,x1,NULL);
			LineTo(g,y2,x1); /* グリッド上横線描画 */
			MoveToEx(g,y1,x2,NULL);
			LineTo(g,y2,x2); /* グリッド下横線描画 */
			if(k>=MIKA_cline_c) break; /* 練習文字の最大数まで描画 */
		}
		SelectObject(g,oldpen); /* 旧ペンを復帰 */
		DeleteObject(pen1); /* 新ペンを破棄 */
	}
...
// flag=0 表示 flag=1 消去 
	...
	void proctrainexit(HDC g)/* ランダム練習 の練習終了時の表示更新 */
	{
	...
	void prockiroku(HDC g) /* ランダム練習 にてタイプ入力速度が前回までの最高速度を更新したかの比較を行う */
	{
		char type_date[9];
...
int getshiftmode(wchar_t a) /* 練習文字に対応した シフトモードを取得 */
...
// charposition >=0 前回のランダム文字位置
	...
	{
		a=char_table[char_position]; /* 前回の文字を取得 */
